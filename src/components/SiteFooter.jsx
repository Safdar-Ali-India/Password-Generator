...
const FOOTER_LINKS = [
  ...
  },
  {
    ...
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
        <path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-4 0v7h-4v-12h4v2.3a4 4 0 0 1 3.5-1.9M2 9h4v12H2zM4 2a2 2 0 0 1 0 4 2 2 0 0 1 0-4z" />
      </svg>
    ),
  },
  {
...
export function SiteFooter() {
  return (
    <footer className="border-t border-zinc-700/80 py-8">
        ...
        <nav className="mt-4 flex items-center justify-center gap-3" aria-label="Social links">
          {FOOTER_LINKS.map((link) => (
            <a
              ...
              title={link.label}
              className="inline-flex h-10 w-10 items-center justify-center rounded-full border border-zinc-700 bg-zinc-800 text-zinc-400 shadow-sm transition-all hover:border-violet-500/50 hover:text-violet-400 hover:shadow"
            >
              {link.icon}
            </a>
          ))}
